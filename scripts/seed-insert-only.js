  ...
  try {
    ...
    for (const studentData of studentsData) {
      try {
        ...
        if (error.code === 11000) {
          console.log(`Student ${studentData.fullName} (ID: ${studentData.studentId}) already exists, skipping...`);
        } else {
          console.error(`Error creating student ${studentData.fullName}:`, error.message);
        }
      }
    }
